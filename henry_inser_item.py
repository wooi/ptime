...
debug = True
if debug:
    xml_path = "/Users/Wooi/WorkSpace/ptime/pod-ptime/henry.xml"
else:
...
def write2xml(title_str, link_str, guid_str, pubDate_str, author_str, download_link):
    ...
    itunes_author = create_c_node("itunes:author", "henry")
    ...
    itunes_image.attrib = {
        "href": "https://cdn.mihk.tv/channel/8/image/program_cover/4bdb0ddc3b33010cf05196c1e868817d.jpg"}
